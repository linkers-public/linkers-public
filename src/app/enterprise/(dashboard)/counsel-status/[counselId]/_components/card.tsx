  ...
  return (
    <div
      style={{
        ...
        marginBottom: '20px',
        width: '100%', // 너비를 100%로 설정하여 여유 공간 확보
        maxWidth: '600px', // 최대 너비를 600px로 제한하여 과도하게 커지지 않도록 함
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Ellipsis size={24} style={{ cursor: 'pointer', color: '#888' }} />
      </div>
      ...
      {/* 내용 설명 */}
      <p style={{ fontSize: '14px', color: '#666', lineHeight: '1.5' }}>{content}</p>
