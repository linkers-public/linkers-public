    ...
    <div className="w-full min-h-screen bg-white">
      <div className="py-8">
        <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
          {/* 헤더 */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">프리랜서 팀 검색</h1>
            <p className="text-gray-600 text-lg">프로젝트에 적합한 팀을 찾아보세요</p>
          </div>
