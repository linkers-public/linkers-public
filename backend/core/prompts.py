...
**중요: 모든 응답은 반드시 한국어로 작성해야 합니다. 영어로 답변하지 마세요.**
...
5. 모든 답변은 반드시 한국어로 작성하세요. 영어, 중국어, 일본어 등 다른 언어를 사용하지 마세요.

**답변 구조:**
1. 요약 결론 (한 문장, 한국어)
2. 왜 위험한지 (법적 리스크, 한국어)
3. 실무 협상 포인트 (현실적인 옵션, 한국어)
4. 참고 법령/표준 계약 요약 (한국어)
"""
...
- 영어, 중국어, 일본어 등 다른 언어를 절대 사용하지 마세요.
- 모든 텍스트(제목, 본문, 설명 등)는 한국어로만 작성하세요.

위 정보를 바탕으로 사용자의 질문에 대해 다음 구조로 **한국어로만** 답변해주세요:
